 ...
 * <p>
 * [3, 8, 9, 7, 6] -> [6, 3, 8, 9, 7] [6, 3, 8, 9, 7] -> [7, 6, 3, 8, 9] [7, 6, 3, 8, 9] -> [9, 7, 6, 3, 8] For another
 * example, given
 * <p>
 ...
 * Assume that:
 * <p>
 * N and K are integers within the range [0..100]; each element of array A is an integer within the range
 * [−1,000..1,000]. In your solution, focus on correctness. The performance of your solution will not be the focus of
 * the assessment.
 */
public class CyclicRotation {
    ...
    public static void main(String[] args) {
        ...
        String sb = Arrays.stream(solutionInts).mapToObj(String::valueOf).collect(Collectors.joining(", "));
